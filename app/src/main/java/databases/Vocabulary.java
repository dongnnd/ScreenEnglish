...
/**
 * Created by DongND on 3/28/2017.
 */
...
public class Vocabulary {
    ...
    public Vocabulary(int vc_id,String word, String spellingaa, String spellingam, String tr_mean, String err1_mean, String err2_mean, byte[] sound){
        this.vc_id=vc_id;
        this.word=word;
