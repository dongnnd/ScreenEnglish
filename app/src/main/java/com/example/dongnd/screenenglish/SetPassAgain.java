...
public class SetPassAgain extends AppCompatActivity implements View.OnClickListener{
    ...
    public ArrayList<Integer> lisrError=new ArrayList<>();
    ...
    public void initSetpass(){
        ...
        ps_title.setText("Nhập lại mật khẩu");
    ...
    public void sendData(ArrayList<Integer> list, int resultCode){
        Intent intent=getIntent();
        Bundle bundle=new Bundle();
        bundle.putIntegerArrayList("pass_word", list);

        intent.putExtra("ketqua", bundle);
